...
enum RouterVersion {
  DelioswapRouter01 = 'DelioswapRouter01',
  DelioswapRouter02 = 'DelioswapRouter02'
}

describe('DelioswapRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.DelioswapRouter01]: fixture.router01,
        [RouterVersion.DelioswapRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.DelioswapRouter01]: 101876,
              [RouterVersion.DelioswapRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.DelioswapRouter01]: 138770,
              [RouterVersion.DelioswapRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
